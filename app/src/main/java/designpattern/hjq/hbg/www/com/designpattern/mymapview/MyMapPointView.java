 ...
 */
public class MyMapPointView extends AppCompatImageView implements View.OnClickListener, View.OnLongClickListener {
    ...
    public MyMapPointView(Context context) {
        super(context);
        init();
    }

    public MyMapPointView(Context context, double firstX, double firstY, int state, String title) {
        super(context);
